...
parfor ij = 1:numel(mGridEpsilon)
    ...
    tempStatesLocalLyapClDyn_Lyap1 = [mGridEpsilon(ij), mGridGamma(ij), ...
        Lyap(:,end)', Lyap(1,end) ];%max(Lyap(:,end)) ];
    
    tempStatesLocalLyapClDyn_Lyap2 = [mGridEpsilon(ij), mGridGamma(ij), ...
        Lyap(:,end)', Lyap(2,end) ];
    
    tempStatesLocalLyapClDyn_Lyap3 = [mGridEpsilon(ij), mGridGamma(ij), ...
