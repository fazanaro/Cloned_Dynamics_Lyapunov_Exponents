...
vGamma = 0.1:nIncControlParameter1:1.0;

vOmega = 0.8:nIncControlParameter2:1.6;
...
parfor_progress( numel(mGridGamma) );


%% ===================================================================== %%
%% MAIN

parfor ij = 1:numel(mGridGamma)
    ...
    tempStatesLocalLyapTanMap_Lyap1 = [mGridGamma(ij), mGridOmega(ij), ...
        Lyap(:,end)', Lyap(1,end) ];%max(Lyap(:,end)) ];
    
    tempStatesLocalLyapTanMap_Lyap2 = [mGridGamma(ij), mGridOmega(ij), ...
        Lyap(:,end)', Lyap(2,end) ];
    
    tempStatesLocalLyapTanMap_Lyap3 = [mGridGamma(ij), mGridOmega(ij), ...
