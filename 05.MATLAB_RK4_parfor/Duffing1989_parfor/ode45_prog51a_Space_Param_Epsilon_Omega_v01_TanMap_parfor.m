...
vOmega   = [0.9, 1.0, 1.4];%0.9:nIncControlParameter2:1.4;
...
parfor ij = 1:numel(mGridEpsilon)
    ...
    tempStatesLocalLyapTanMap_Lyap1 = [mGridEpsilon(ij), mGridOmega(ij), ...
        Lyap(:,end)', Lyap(1,end) ];%max(Lyap(:,end)) ];
    
    tempStatesLocalLyapTanMap_Lyap2 = [mGridEpsilon(ij), mGridOmega(ij), ...
        Lyap(:,end)', Lyap(2,end) ];
    
    tempStatesLocalLyapTanMap_Lyap3 = [mGridEpsilon(ij), mGridOmega(ij), ...
