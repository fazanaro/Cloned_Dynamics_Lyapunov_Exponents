/* ***********************************************************************************************************************************
 *
 * Name				: RK4_mod_C_Duffing1989_SpaceParam_ClDyn_epsilon_omega.c
 ...
 * cloned dynamics and its application to the discontinuously-excited FitzHugh-Nagumo model. Nonlinear Dynamics,
...
int main()
{
	...
	//		2-) Control parameter 2 = omega
	//		2-) others parameters   = gamma
	//		3-) Lyap1, Lyap2, Lyap3
	//		4-) tItera
	...
	double nIncControlParameter2 = 0.5;


	// ---------------------------------------------------------------------------------------------------------------------------- //
	// CONTROL PARAMETER VECTOR CONSTRUCTION -------------------------------------------------------------------------------------- //
	// ---------------------------------------------------------------------------------------------------------------------------- //
	double vEpsilon_min = 0.25;
	double vEpsilon_max = 0.25;

	double vOmega_min = 0.5;
	double vOmega_max = 1.0;


	int vEpsilon_length = round( ((vEpsilon_max - vEpsilon_min)/nIncControlParameter1) + 1 );
	int vOmega_length   = round( ((vOmega_max   - vOmega_min)  /nIncControlParameter2) + 1 );


	double vEpsilon[vEpsilon_length];
	double vOmega[vOmega_length];
	...
	for( unsigned int ii = 0; ii < vOmega_length; ii++ )
	{
		if ( ii == 0 )
			vOmega[ii] = vOmega_min;

		else
			vOmega[ii] = vOmega[ii-1] + nIncControlParameter2;
	...
	//double Mz_Lyap[(vEpsilon_length)*(vOmega_length)][dim+numExtraSaves];

	int nRows = (vEpsilon_length)*(vOmega_length);
	...
	FILE *fileData_Header = fopen("data_C_RK4_mod_Duffing1989_SpaceParam_ClDyn_Header.dat", "w+");
	...
	FILE *fileData_Mz_Lyap = fopen("data_C_RK4_mod_Duffing1989_SpaceParam_ClDyn_Mz_Lyap.dat", "w+");

	// ---------------------------------------------------------------------------------------------------------------------------- //

	if (fileData_Header == NULL)
	{
		printf(" Error opening the file 'data_C_RK4_mod_Duffing1989_SpaceParam_ClDyn_Header.dat' !\n");
		exit(1);
	}
	...
	{
		printf(" Error opening the file 'data_C_RK4_mod_Duffing1989_SpaceParam_ClDyn_Mz_Lyap.dat' !\n");
		exit(1);
	}
	...
	for( unsigned int idx_vEpsilon = 0; idx_vEpsilon < vEpsilon_length; idx_vEpsilon++ )
	{
		...
		/* ************************************************************************************************************************ */
		/* INITIATES THE MAIN LOOP - CONTROL PARAMETER 2 ************************************************************************** */
		/* ************************************************************************************************************************ */

		for( unsigned int idx_vOmega = 0; idx_vOmega < vOmega_length; idx_vOmega++ )
		{
			...
			epsilon = vEpsilon[idx_vEpsilon];
			omega   = vOmega[idx_vOmega];


			printf( "epsilon = %.6f  ", epsilon );
			...
			/* ******************************************************************************************************************** */
			/* STORE: CONTROL PARAMETERS, LYAPUNOV EXPONENTS ********************************************************************** */
			/* ******************************************************************************************************************** */
	...
	} // END - loop control parameter: epsilon
	/* **************************************************************************************************************************** */
	...
	fprintf(fileData_Header, "Control parameters: epsilon, omega\n");
	...
	fprintf(fileData_Header, "vEpsilon_min = %.6f\n", vEpsilon_min);
	fprintf(fileData_Header, "vEpsilon_max = %.6f\n", vEpsilon_max);
	fprintf(fileData_Header, "\n");


	fprintf(fileData_Header, "vOmega_min = %.6f\n", vOmega_min);
	fprintf(fileData_Header, "vOmega_max = %.6f\n", vOmega_max);
	fprintf(fileData_Header, "\n");


	fprintf(fileData_Header, "vEpsilon_length = %d\n", vEpsilon_length);
	fprintf(fileData_Header, "vOmega_length = %d\n", vOmega_length);
	fprintf(fileData_Header, "\n");
