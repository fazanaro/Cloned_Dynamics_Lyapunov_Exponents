...
int main()
{
	...
	int vOmega_length = round( ((vOmega_max - vOmega_min)/nIncControlParameter1) + 1 );
	...
	for ( unsigned int ii = 0; ii < vOmega_length; ii++ )
	{
		if (ii == 0)
			...
			vOmega[ii] = vOmega[ii-1] + nIncControlParameter1;
	...
	FILE *fileData_Mz_Lyap = fopen("data_C_RK4_mod_Duffing1989_bifurc_ClDyn_Omega.dat", "w+");
	...
	{
		printf(" Error opening the file 'data_C_RK4_mod_Duffing1989_bifurc_ClDyn_Omega.dat' !\n");
		exit(1);
	}
	...
	} // END - loop control parameter: omega
	/* **************************************************************************************************************************** */
	...
	fprintf(fileData_Header, "Control parameters: omega\n");
