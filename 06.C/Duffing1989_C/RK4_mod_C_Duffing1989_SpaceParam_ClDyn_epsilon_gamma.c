/* ***********************************************************************************************************************************
 *
 * Name				: RK4_mod_C_Duffing1989_SpaceParam_ClDyn_epsilon_gamma.c
...
int main()
{
	...
	double nIncControlParameter2 = 0.2;
	...
	//double Mz_Lyap[(vEpsilon_length)*(vGamma_length)][dim+numExtraSaves];

	int nRows = (vEpsilon_length)*(vGamma_length);
