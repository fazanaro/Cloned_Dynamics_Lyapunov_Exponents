/* ***********************************************************************************************************************************
 *
 * Name				: RK4_mod_C_Duffing1989_bifurc_ClDyn_epsilon.c
...
int main()
{
	...
	FILE *fileData_Mz_Lyap = fopen("data_C_RK4_mod_Duffing1989_bifurc_ClDyn_Epsilon.dat", "w+");
	...
	{
		printf(" Error opening the file 'data_C_RK4_mod_Duffing1989_bifurc_ClDyn_Epsilon.dat' !\n");
		exit(1);
	}
...
//		printf( "\n" );
	...
	fprintf(fileData_Header, "Control parameters: epsilon\n");
