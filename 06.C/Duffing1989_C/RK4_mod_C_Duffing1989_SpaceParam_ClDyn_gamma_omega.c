/* ***********************************************************************************************************************************
 *
 * Name				: RK4_mod_C_Duffing1989_SpaceParam_ClDyn_gamma_omega.c
...
int main()
{
	...
	//double Mz_Lyap[(vGamma_length)*(vOmega_length)][dim+numExtraSaves];

	int nRows = (vGamma_length)*(vOmega_length);
	...
	fprintf(fileData_Header, "Control parameters: gamma, omega\n");
