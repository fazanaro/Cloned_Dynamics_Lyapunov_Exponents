...
vEpsilon = [0.2, 0.22, 0.25];%0.0:nIncControlParameter1:1.0;

vGamma   = [0.1, 0.3];%0.2:nIncControlParameter2:1.0;
...
mStatesLocalLyapTanMap_Lyap1 = [];
mStatesLocalLyapTanMap_Lyap2 = [];
mStatesLocalLyapTanMap_Lyap3 = [];
...
parfor_progress( numel(mGridEpsilon) );


%% ===================================================================== %%
%% MAIN

parfor ij = 1:numel(mGridEpsilon)
    ...
    tempStatesLocalLyapTanMap_Lyap1 = [mGridEpsilon(ij), mGridGamma(ij), ...
        Lyap(:,end)', Lyap(1,end) ];%max(Lyap(:,end)) ];
    
    tempStatesLocalLyapTanMap_Lyap2 = [mGridEpsilon(ij), mGridGamma(ij), ...
        Lyap(:,end)', Lyap(2,end) ];
    
    tempStatesLocalLyapTanMap_Lyap3 = [mGridEpsilon(ij), mGridGamma(ij), ...
        Lyap(:,end)', Lyap(3,end) ];%min(Lyap(:,end)) ];
    
    % ------------------------------------------------------------------- %
    
    Mz_Lyap1(ij) = tempStatesLocalLyapTanMap_Lyap1(end,end);
    Mz_Lyap2(ij) = tempStatesLocalLyapTanMap_Lyap2(end,end);
    Mz_Lyap3(ij) = tempStatesLocalLyapTanMap_Lyap3(end,end);
    
    mStatesLocalLyapTanMap_Lyap1(ij,:) = tempStatesLocalLyapTanMap_Lyap1;
    mStatesLocalLyapTanMap_Lyap2(ij,:) = tempStatesLocalLyapTanMap_Lyap2;
    mStatesLocalLyapTanMap_Lyap3(ij,:) = tempStatesLocalLyapTanMap_Lyap3;
...
surf(mGridEpsilon, mGridGamma, Mz_Lyap1);
...
axis([ min(vEpsilon) max(vEpsilon) min(vGamma) max(vGamma) ]);
...
surf(mGridEpsilon, mGridGamma, Mz_Lyap2);
...
surf(mGridEpsilon, mGridGamma, Mz_Lyap3);
