...
%   [1,2].
%
%   - Defines 'omega' as the control parameter.
%
...
nIncControlParameter = 0.5;

% Control parameter
vOmega = 0.0:nIncControlParameter:4.0;
...
vBifurcLyap = 255*ones( length(vOmega), (dim+1) );
...
parfor_progress( numel(vOmega) );


%% ===================================================================== %%
%% DYNAMICAL SYSTEM INTEGRATION

parfor iOmega = 1:length(vOmega)
    ...
    vBifurcLyap(iOmega,:) = [ omega, Lyap(:,end)' ];
...
line([min(vOmega) max(vOmega)], [0 0], ...
    'Color', [0 0 0]);
