...
%% ===================================================================== %%
%% NOME DO ARQUIVO:
%   - cuda_prog04e_Bifurcacao_ClDyn_kernel_varia_Omega.m
%
%
...
nIncControlParameter = 0.05;

% Definicao do vetor de variacao do parametro de controle
%   - Definido como um vetor COLUNA;
vOmega = 0:nIncControlParameter:4.0;
vOmega = vOmega';

% Numero total de elementos
numElementos = numel( vOmega );

nComprimento = length( vOmega );   % redundante; eh usada no script das LCS
...
vBifurcLyap  = [ vOmega, vEpsilon, vGamma, Lyap1, Lyap2, Lyap3 ];
...
sSave = ['save dados_bifurc_Lyap_vOmega_' num2str(vOmega(1)) 'a' num2str(vOmega(end)) '_IncPar_' num2str(nIncControlParameter) '_tf_' num2str(t_final) '_GPU_CUDA_Kernel.mat'];
eval(sSave);
