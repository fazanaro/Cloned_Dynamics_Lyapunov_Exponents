% Ultima atualizacao: 03/02/2014



%% ===================================================================== %%
%% NOME DO ARQUIVO:
%   - cuda_prog04a_Bifurcacao_ClDyn_kernel_varia_Epsilon.m
%
%
...
eval(['!/usr/local/cuda-6.0/bin/nvcc -ptx cudaDuffing1989RK4_Bifurc_v01.cu']);
...
for ii = 1:nComprimento
    
    fprintf('| Lyap1 = %.6f | Lyap2 = %.6f | Lyap3 = %.6f |\n', Lyap1(ii), Lyap2(ii), Lyap3(ii));
...
vBifurcLyap  = [ vEpsilon, vGamma, vOmega, Lyap1, Lyap2, Lyap3 ];
...
% sSave = ['save dados_bifurc_Lyap_vEpsilon_' num2str(vEpsilon(1)) 'a' num2str(vEpsilon(end)) '_IncPar_' num2str(nIncControlParameter) '_tf_' num2str(t_final) '_GPU_CUDA_Kernel.mat'];
% eval(sSave);
